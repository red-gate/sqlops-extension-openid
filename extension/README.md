...
# sample-openid README

This is the README for your extension "sample-openid". After writing up a brief description, we recommend including the following sections.
